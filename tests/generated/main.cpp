/*----- PROTECTED REGION ID(TangoTestServer::main.cpp) ENABLED START -----*/
/* clang-format on */
//=============================================================================
//
// file :        main.cpp
//
// description : C++ source for the TangoTestServer device server main.
...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    tg->register_dserver_constructor(&TangoTestServer_ns::constructor);
#endif
...
/* clang-format off */
/*----- PROTECTED REGION END -----*/	//	TangoTestServer::main.cpp
